package au.edu.adelaide.integration.app.aims.details.routes;
...
public class Route extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("cxfrs:bean:aimsDataServiceEndpoint?bindingStyle=SimpleConsumer").routeId("orgperson_service_v1_route")
                .log(LoggingLevel.INFO,logger.getName(),"AIMS Request received")
                ...
                .setBody(constant(""))
                .log(LoggingLevel.DEBUG, logger, "calling api Service to get info")
                .setHeader(HttpHeaders.AUTHORIZATION, simple("Bearer ${bean:oAuth2RestTemplate?method=getAccessToken}"))
                .to("cxfrs:bean:apiRestClient")
                ...
                .log(LoggingLevel.DEBUG,logger.getName()," api call response  ${body}");
    }
}
